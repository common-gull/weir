 ...
 *  cap. A spec mount that reuses a weir-supplied container path (/weir, the module mount) is refused
 *  rather than allowed to shadow it under docker's last-`-v`-wins semantics. */
