...
- `src/tools/` — generic primitives usable by workflows (`claude`, `fs`, `notify`, …).
...
| Where | What |
| --- | --- |
| `src/tools/` | Engine-shipped primitives (`runClaude`, …). weir owns these — don't edit them to add a workflow feature. |
